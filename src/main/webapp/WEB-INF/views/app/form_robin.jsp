                ...
                <div class="col-12" style="margin-top: 20px;">
                  <div class="card mb-6">
                    ...
                    <table class="app_table_container">
                      <thead>
                        <tr>
                          <td class="app_type"><span id="form_type_result">품&nbsp;&nbsp;의&nbsp;&nbsp;서</span></td>
                          <td class="line_div">
                   ...
                   <!-- db 조회해서 담기 -->
                    <table class="app_table_container">
                      <tr class="app_result_div">
                        ...
                        <td class="dept_td_result">${d.deptName}</td>
                        <td class="app_date">직급</td>
                        <td class="app_date_result">${d.posName}</td>
                    ...
                    <table style="border-spacing: 0;">
                      <tr>
                        ...
                        <td class="app_title_result" style="width: 788px; border: 1px solid black; ">
                          <span style="position: relative; left: 10px;">${d.memName}</span>
                        </td>
                      </tr>
                    </table>
