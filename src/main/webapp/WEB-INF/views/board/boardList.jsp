...
<script>
  ...
  function deleteSelectedPosts() {
    ...
    const selectedBoardNos = Array.from(checkboxes).map(checkbox => checkbox.closest('tr').dataset.boardno);
    ...
    if (confirm('선택한 게시물을 삭제하시겠습니까?')) {
      ...
      form.method = 'post';
      form.action = "${contextPath}/board/deleteSelectedPosts.do";
      selectedBoardNos.forEach(boardNo => {
