        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <div class="container card" style="padding: 50px;">
            <div style="align-items: center;">
              <div>
                <span style="font-size: 24px;">공지사항 수정</span><br><br><br>
                ...
                <br>
                <label for="selectpickerMultiple" class="form-label">읽기권한</label>
                  <select
                    id="selectpickerMultiple"
                    class="selectpicker w-100"
                    data-style="btn-default"
                    multiple
                    placeholder="권한을 설정하세요."
                    data-icon-base="ti"
                ...
                <br>
                <label class="d-block form-label">상단고정</label>
                <div style="display: flex; align-items: center;">
                  <div class="form-check mb-2" style="margin-right: 10px;">
                    <input
                      type="radio"
                      id="basic-default-radio-Yes"
                      name="basic-default-radio"
                      class="form-check-input"
                      required/>
                    <label class="form-check-label" for="basic-default-radio-Yes">Yes</label>
                  </div>
                  <div class="form-check">
                    <input
                      type="radio"
                      id="basic-default-radio-No"
                      name="basic-default-radio"
                      class="form-check-input"
                      required 
                      checked/>
                    <label class="form-check-label" for="basic-default-radio-No">No</label>
                  </div>
                </div>
                <div id="full-editor">
                  공지사항 내용입니다.
